	...
	<section id='features' className={layout.section}>
		...
		<motion.div
			...
			<p className={`${styles.paragraph} max-w-[500px] mt-2`}>
				We take pride in our strong partnerships and the trust we've earned from our valued clients.
				Our commitment to excellence has led us to collaborate with reputable organizations and
